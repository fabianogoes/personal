...
" backups
set nobackup " desabilita os backups
set noswapfile " evitar arquivos temporarios
set nowritebackup " evitar arquivos tmp que comecam com ~~


" Tabs. May be overriten by autocmd rules
set ai " auto identacao
set ci " recuo
set expandtab " cria espacos no lugar de tabulacao
set tabstop=4
set softtabstop=0
set shiftwidth=4
set expandtab
...
set sn " mostrar o inicio de um bloco recem fechar {}, (), []
...
"{{{
" Conf Fabiano
let g:snips_author = "Fabiano Goes"
